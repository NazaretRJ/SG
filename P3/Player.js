...
class Player extends THREE.Object3D {
   ...
   ConvertDegreesToRadians(degrees){
    ...
    createWheel(){
        ...
        var material = loader.load("imgs/llamas.png");
    ...
    createArm(){
 	...
 	var loader = new THREE.TextureLoader();
        var pict = loader.load("imgs/brazo.png");
        var mat = new THREE.MeshPhongMaterial ({map:pict});
        //var mat = new THREE.MeshBasicMaterial( {color: 0x253cea} );
        //arm
        ...
        var mat2 = new THREE.MeshBasicMaterial( {color: 0x253cea} );
    ...
    createBody(){
        ...
        var loader = new THREE.TextureLoader();
        var material = loader.load("imgs/cuerpo.png");
    ...
    restart(){
        ...
        this.setAngleHead_X(0);
        this.setAngleHead_Y(0);
        this.rotation.y = 0;
    }
