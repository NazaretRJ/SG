...
function createGUI (withStats) {
  GUIcontrols = new function() {
    ...
    this.takeBox  = false;
	//EXAMEN
	this.Position = function (){	//boton
		scene.setCranePosition();
	}
  }
  ...
  var craneControls = gui.addFolder ('Crane Controls');
	...
	//EXAMEN
	craneControls.add (GUIcontrols,'Position').name('Posicion fija');//añadimos el boton a la carpeta craneControls
